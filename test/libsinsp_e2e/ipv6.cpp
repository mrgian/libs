...
TEST_F(ipv6_filtercheck_test, curl_google_dnsreq)
{
	...
	read_file("./test/libsinsp/resources/ipv6_traces/curl_google.scap",
	          "thread.tid=17498",
	          [this](sinsp_evt* evt)
	          {
...
TEST_F(ipv6_filtercheck_test, single_ipv6_conn_client)
{
	...
	read_file("./test/libsinsp/resources/ipv6_traces/single_ipv6_conn.scap",
	          "proc.pid=25888",
	          [this](sinsp_evt* evt)
	          {
		          string evname = string(evt->get_name());
...
TEST_F(ipv6_filtercheck_test, test_ipv6_client)
{
	...
	read_file(
	    "./test/libsinsp/resources/ipv6_traces/test_ipv6_client.scap",
