...
{	
	...
	ASSERT_EQ(std::string(metrics_snapshot.at(metrics_snapshot.size() - 2).name), "sample_metrics.dummy_metric");
	ASSERT_EQ(std::string(metrics_snapshot.back().name), "sample_metrics.evt_count");
